...
{
    public sealed class RejectLoanApplicationCommand : IUpdateCommand<CommandResult>
    {
        public Guid LoanApplicationId { get; private set; }
        public Guid OperatorId { get; private set; }
        public RejectLoanApplicationCommand(Guid loanApplicationId, Guid operatorId)
        {
            LoanApplicationId = loanApplicationId;
            OperatorId = operatorId;
        }
    }
    public sealed class RejectLoanApplicationCommandHandler : UpdateCommandHandler<RejectLoanApplicationCommand, CommandResult>
    {
        ...
        public RejectLoanApplicationCommandHandler(ILoanRepository<LoanApplication> repository, ILoanRepository<Operator> operatorrepository, IUnitOfWork unitOfWork) : base(unitOfWork)
        {
            _repository = repository;
            _operatorrepository = operatorrepository;
        }

        public override async Task<CommandResult> Handle(RejectLoanApplicationCommand request, CancellationToken cancellationToken)
        {
