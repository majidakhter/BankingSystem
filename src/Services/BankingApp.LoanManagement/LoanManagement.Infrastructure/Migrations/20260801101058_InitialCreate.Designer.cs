...
namespace LoanManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260801101058_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.DebtInfos.Entities.DebtorInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.LoanApplications.Entities.LoanApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.LoanApplications.Entities.Operator", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.LoanApplications.Models.LoanType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.DebtInfos.Entities.DebtorInfo", b =>
                {
                    b.OwnsMany("BankingAppDDD.Domains.DebtInfos.ValueObjects.Debt", "Debts", b1 =>
                        {
            ...
            modelBuilder.Entity("BankingAppDDD.Domains.LoanApplications.Entities.LoanApplication", b =>
                {
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.Asset", "Asset", b1 =>
                        {
                    ...
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.Customer", "Customer", b1 =>
                        {
                            b1.Property<Guid>("LoanApplicationId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.Loan", "Loan", b1 =>
                        {
                            b1.Property<Guid>("LoanApplicationId")
                                .HasColumnType("uuid");
                            ...
                            b1.OwnsOne("BankingAppDDD.Domains.Abstractions.ValueObjects.Shared.Percent", "InterestRate", b2 =>
                                {
                    ...
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.LoanUnderWriter", "Decision", b1 =>
                        {
                            b1.Property<Guid>("LoanApplicationId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.Registration", "Registration", b1 =>
                        {
                            b1.Property<Guid>("LoanApplicationId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("BankingAppDDD.Domains.LoanApplications.ValueObjects.ScoringResult", "Score", b1 =>
                        {
                            b1.Property<Guid>("LoanApplicationId")
                                .HasColumnType("uuid");
